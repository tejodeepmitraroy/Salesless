		...
		<Card className="border border-gray-200 transition-shadow hover:shadow-md">
			<CardContent className="p-6">
				<div className="mb-4">
					...
					>
						<path
							d="M13.5 18H9C9.83333 12.5 13.5 9.5 18 9L16.5 4.5C9.5 6 4 12 4.5 22.5C4.83333 28.6667 8 31.5 12 31.5C14.8333 31.5 18 29.5 18 24.5C18 20.5 16.3333 18.5 13.5 18ZM34.5 18H30C30.8333 12.5 34.5 9.5 39 9L37.5 4.5C30.5 6 25 12 25.5 22.5C25.8333 28.6667 29 31.5 33 31.5C35.8333 31.5 39 29.5 39 24.5C39 20.5 37.3333 18.5 34.5 18Z"
							fill="currentColor"
						/>
					</svg>
				</div>
