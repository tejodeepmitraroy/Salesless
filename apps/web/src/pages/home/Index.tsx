...
const Index = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="bg-blue-600 py-20 px-4 overflow-hidden relative">
        <div className="absolute inset-0 bg-gradient-to-br from-blue-500 to-blue-700 z-0"></div>
        <div className="absolute -top-16 -left-16 w-64 h-64 bg-yellow-300 rounded-full opacity-10"></div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              >
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-gray-900">
                  Control your sales
                  <br />with confidence & ease
                </h1>
                <p className="text-xl md:text-2xl text-gray-700">
                  Everything you need to manage, track, and finalize sales — all in one clear, actionable space.
                </p>
                <div className="pt-4 flex flex-col sm:flex-row gap-4">
                  <Button size="lg" className="bg-[#FF6600] hover:bg-orange-700 text-white px-8">
                    Sign up for free
                  </Button>
      ...
      <motion.section 
        className="bg-[#FF6600] text-white py-4"
        initial={{ opacity: 0, y: -10 }}
        animate={{ opacity: 1, y: 0 }}
        ...
        <div className="container mx-auto text-center">
          <div className="flex flex-col md:flex-row items-center justify-center gap-4">
            <div className="flex items-center">
              ...
              <span className="font-bold">🚀 30-Day Money-Back Guarantee – Offer Ends in:</span>
            </div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              As your budgets get squeezed even tighter, every decision counts! Having a clear overview of your contracts means seeing all available opportunities at the right time—ASAP.
            </p>
          </motion.div>
          ...
          <div className="mt-12 text-center">
            <Button size="lg" className="bg-[#00B86B] hover:bg-green-700 text-white px-8">
          ...
          <Card className="border border-gray-200 shadow-lg">
            <CardContent className="p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex flex-col space-y-1.5">
                  <label htmlFor="framework" className="font-medium">Which framework do you use? (Optional)</label>
                  <Textarea 
                    id="framework"
                ...
                <div className="pt-4">
                  <Button 
                    type="submit" 
                    className="w-full bg-[#00B86B] hover:bg-green-700 text-white"
                    size="lg"
                  >
                    Claim Your CRM Now
                  </Button>
      ...
      >
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">SalesSync</h3>
              <p className="text-gray-400">
                The ultimate headless e-commerce operating system for modern developers.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400">&copy; 2025 SalesSync. All rights reserved.</p>
