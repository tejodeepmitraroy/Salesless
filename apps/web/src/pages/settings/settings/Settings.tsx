								...
								<div className="space-y-4">
									...
									<motion.div variants={itemVariants} className="space-y-2">
										...
										<Input
											...
											onChange={(e) =>
												handleStoreChange('name', e.target.value)
											}
										/>
									</motion.div>
									...
									<motion.div variants={itemVariants} className="space-y-2">
										...
										<Input
											...
											onChange={(e) =>
												handleStoreChange('domain', e.target.value)
											}
										/>
									...
									<div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
										<motion.div variants={itemVariants} className="space-y-2">
											...
											<Input
												...
												onChange={(e) =>
													handleStoreChange('city', e.target.value)
												}
											/>
										</motion.div>
										...
										<motion.div variants={itemVariants} className="space-y-2">
											...
											<Input
												...
												value={storeData.zip}
												onChange={(e) =>
													handleStoreChange('zip', e.target.value)
												}
											/>
										</motion.div>
									</div>
									...
									<motion.div variants={itemVariants} className="space-y-2">
										...
										<div className="flex">
											...
											<Input
												...
												onChange={(e) =>
													handleStoreChange('phone', e.target.value)
												}
											/>
										</div>
									</motion.div>
								...
								<div className="space-y-4 pt-2">
									...
									<motion.div variants={itemVariants} className="space-y-2">
										...
										<Select
											...
											onValueChange={(value) =>
												handleStoreChange('timezone', value)
											}
										>
							...
							<CardContent className="space-y-4">
								...
								<motion.div variants={itemVariants} className="space-y-2">
									...
									<Input
										id="contact-email"
										type="email"
										placeholder="support@vendorsphere.com"
									/>
								</motion.div>
							</CardContent>
							<CardFooter>
