	...
	pendingVendors: [
		{
			...
			description:
				'Handmade artisan crafts from local artists. Specializing in pottery, jewelry, and home decor.',
		},
		{
			id: 2,
	...
	activeVendors: [
		{
			...
			description:
				'Premium home decor items handcrafted by skilled artisans from around the world.',
		},
		{
			id: 5,
			name: 'Tech Universe',
		...
		},
		{
			...
			description:
				'Trendy clothing and accessories for the fashion-conscious consumer.',
		},
	],
	selectedVendor: null,
	searchQuery: '',
